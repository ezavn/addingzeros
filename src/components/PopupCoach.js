  ...
  return (
    <>
      {!!show ? (
        ...
        >
          <div className=" absolute top-[50px] left-[50%] translate-x-[-50%] z-[50]">
            <img src="/images/pop-title.png" alt="" />
          </div>
          <img
            className="absolute top-[150px] left-0 cursor-pointer md:block hidden"
            srcSet="/icons/back-icon.png 3x"
            alt=""
            onClick={() => setShow(false)}
          />
          <div className="rounded-[20px] mt-[500px] md:mt-[100px] relative max-w-[1400px] bg-black text-white overflow-y-auto pt-[90px] md:pt-[130px] md:pl-[45px] pb-[45px] md:pb-[90px] md:pr-[100px] px-[30px]">
